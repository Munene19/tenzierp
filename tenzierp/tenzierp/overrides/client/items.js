      ...
      if (!frm.doc.custom_item_registered) {
        frm.add_custom_button(
          ...
          function () {
            ...
            frappe.call({
              method:
                "tenzierp.tenzierp.apis.apis.perform_item_registration",
              args: {
                request_data: {
                  name: frm.doc.name,
      ...
      if (frm.doc.is_stock_item) {
        frm.add_custom_button(
          ...
          function () {
            frappe.call({
              method:
                "tenzierp.tenzierp.apis.apis.submit_inventory",
              args: {
                request_data: {
                  company_name: companyName,
                  name: frm.doc.name,
      ...
      if (
        ...
        frm.add_custom_button(
          ...
          function () {
            frappe.call({
              method:
                "tenzierp.tenzierp.apis.apis.send_imported_item_request",
              args: {
                request_data: {
                  company_name: companyName,
                  name: frm.doc.name,
